    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div id="main" class="col-md-9">
          ...
          <h4><b>KONFIRMASI PEMBAYARAN DENDA</b></h4>
          <br>
          ...
          <div>
            ...
            <div class="row">
              ...
              <div class="col-lg-12">
                ...
                <br/>
                <p>Silahkan Lakukan Pembayaran Denda Ke Nomor Rekening Berikut :</p>
                <table class="table table-bordered">
                  <tr>
                ...
                <form action="customer_pembayaran_denda_act.php" method="post" enctype="multipart/form-data">
